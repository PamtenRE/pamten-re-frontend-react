    ...
    <div className="space-y-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Add your education, work experience, certifications, projects, and
          research papers.
        </p>
      </div>
      ...
      <div>
        ...
        {form.education.map((edu, index) => (
          <div
            key={edu.id}
            className="grid grid-cols-1 gap-4 sm:grid-cols-2 mb-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg relative bg-white dark:bg-gray-800"
          >
            <button
              type="button"
              onClick={() => deleteEducation(edu.id)}
              className="absolute top-2 right-2 p-1 text-gray-500 hover:text-red-600 dark:text-gray-400 dark:hover:text-red-400"
            >
              <svg
                className="w-4 h-4"
                fill="none"
        ...
        <button
          ...
          className="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-sm font-medium bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700"
        >
          + Add Education
        </button>
      </div>
          ...
          >
            ...
            <div className="sm:col-span-2">
              ...
              <input
                ...
                accept="image/*"
                onChange={(e) =>
                  updateCertification(index, "image", e.target.files?.[0])
                }
                className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 px-4 py-3 file:mr-4 file:rounded-md file:border-0 file:bg-blue-600 file:px-3 file:py-2 file:text-white hover:file:bg-blue-700"
              />
            </div>
          </div>
        ))}
      ...
      <div>
        ...
        {form.workExperience.map((work, index) => (
          <div
            key={work.id}
            className="grid grid-cols-1 gap-4 mb-4 p-4 border border-gray-200 dark:border-gray-700 rounded-lg relative bg-white dark:bg-gray-800"
          >
            <button
              type="button"
            ...
            {/* Description with AIEnhanceButton */}
            <div>
              ...
              <div className="mt-2">
                <AIEnhanceButton
                  sectionName={`Work Experience #${index + 1}`}
                  text={work.description}
                  onEnhance={(enhanced) =>
                    updateWorkExperience(index, "description", enhanced)
                  }
                />
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              <RichTextEditor
                ...
                rows={3}
                placeholder="Describe your project goals, technologies, and outcomes..."
                minHeight="120px"
              />
              <div className="mt-2">
                <AIEnhanceButton
                  sectionName={`Project #${index + 1}`}
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                value={paper.title}
                onChange={(e) =>
                  updateResearchPaper(index, "title", e.target.value)
                }
            ...
            <div>
              ...
              <input
                ...
                value={paper.link}
                onChange={(e) =>
                  updateResearchPaper(index, "link", e.target.value)
                }
